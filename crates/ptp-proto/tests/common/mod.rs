...
/// the line. The function then removes all whitespace. The function reads the
/// remaining characters as pairs of hexadecimal digits.
///
/// The function panics if the file is absent or the content is not valid.
/// A panic is correct here, because a broken fixture is a broken test.
